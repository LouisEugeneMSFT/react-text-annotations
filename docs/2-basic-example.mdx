...
- Choose which annotation / relation to use from the legend at the top.
- With annotations, select text and hit "Enter" to create a new one.
- With relations, select the "from" text and hit "Enter", then do the same for the "to" text to create a new one.
- Right click on an annotation or relation to view its contextual menu.
